...
- Pending delivery-time steps (each under separate owner authorization): commit/push/PR; deployed-stack verification through the new backfill step; TS-026 full live re-baseline under the new signature (Spec D5, review M-1).
