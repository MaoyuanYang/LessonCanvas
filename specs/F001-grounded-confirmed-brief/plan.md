...
- [ ] T5 Discovery core: LangGraph workflow with 6x3 cap + gap rules; DeepSeek adapter + scripted fake; run model, idempotency constraints, trace capture; TS-007/008/009/014/015/020/021 PASS; capped live smoke recorded.
- [ ] T6 Streaming: SSE endpoint, answers, stop-narration, re-ask, reconnect-from-state; TS-010 PASS.
- [ ] T7 Brief + confirmation: draft revisions, PATCH with base revision, atomic immutable confirmation; TS-011/012/013 + confirm-race PASS.
- [ ] T8 Discovery/brief UI: conversation panel (streaming/stop/re-ask), brief panel (citations, gap markers, correction, confirm modal), stale-conflict banner; TS-022 (workspace surfaces) PASS.
- [ ] T9 Deletion: project cascade + account deletion with Clerk ordering; audit rows; failure states; TS-018/019 PASS; account & usage UI.
